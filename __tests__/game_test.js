...
describe('Game', function() {
    describe('#fight()', function() {
        it('should be logger player vs player message', function() {
            ...
            game.fight();
            var expectText = 'Katherine攻击了Stefan，Stefan受到了8点伤害，Stefan剩余生命：22\n' +
                             'Stefan攻击了Katherine，Katherine受到了10点伤害，Katherine剩余生命：20\n' +
                             'Katherine攻击了Stefan，Stefan受到了8点伤害，Stefan剩余生命：14\n' +
                             'Stefan攻击了Katherine，Katherine受到了10点伤害，Katherine剩余生命：10\n' +
                             'Katherine攻击了Stefan，Stefan受到了8点伤害，Stefan剩余生命：6\n' +
